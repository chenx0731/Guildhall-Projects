...
GamePause::GamePause() : Game()
{
	...
	Button* button1 = new Button("Resume Game", bound1, g_uiFont);
	Button* button2 = new Button("Main Menu", bound2, g_uiFont);
...
void GamePause::LoadAssets()
{
	
}


void GamePause::UpdateFromKeyboard()
{
...
void GamePause::UpdateFromController()
{

}

void GamePause::RenderAttractMode() const
{
...
void GamePause::RenderUI() const
{
	...
	g_uiFont->AddVertsForTextInBox2D(text, textBox, 100.f, "Pause Menu");
