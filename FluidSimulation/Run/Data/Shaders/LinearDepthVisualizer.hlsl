...
float4 PixelMain(v2p_t input) : SV_Target0
{
    ...
    resultingColor.g = resultingColor.r; 
    resultingColor.b = resultingColor.r; 
    if (resultingColor.r > 0.999f)
        resultingColor.a = 0.f;
    if (resultingColor.a == 0)
        discard;
/*
    resultingColor.r = resultingColor.r * resultingColor.r;
    resultingColor.g = resultingColor.r; 
    resultingColor.b = resultingColor.r; */
    resultingColor.a = resultingColor.r; 
