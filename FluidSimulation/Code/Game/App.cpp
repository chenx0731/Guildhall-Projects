...
{	
	...
	windowConfig.m_windowTitle = "Fluid Simulation";
	...
	g_ImGui = new StatusGui(g_theGame, imGuiSystemConfig);
	g_ImGui->Startup();
	...
	std::string test = "LoadGameConfig File=\"Data / <filename>.xml\"";
