...
void DrawSquare(Vec2 const& start, Vec2 const& end, Rgba8 color)
{
	...
	verts[1].m_position = Vec3(start.x, end.y, 0.f);
	verts[2].m_position = Vec3(end.x, start.y, 0.f);
...
{
	{
		int zoneIndex = g_rng->RollRandomIntInRange(1, 4);
		float x = 0.f;
		float y = 0.f;
		switch (zoneIndex)
		{
		case 1:
			x = g_rng->RollRandomFloatInRange(-5.f, WORLD_SIZE_X + 5.f);
			y = g_rng->RollRandomFloatInRange(WORLD_SIZE_Y + 3.f, WORLD_SIZE_Y + 13.f);
			break;
		case 2:
			x = g_rng->RollRandomFloatInRange(-5.f, WORLD_SIZE_X + 5.f);
			y = g_rng->RollRandomFloatInRange(-3.f, -13.f);
			break;
		case 3:
			x = g_rng->RollRandomFloatInRange(-3.f, -13.f);
			y = g_rng->RollRandomFloatInRange(0.f, WORLD_SIZE_Y);
			break;
		case 4:
			x = g_rng->RollRandomFloatInRange(WORLD_SIZE_X + 3.f, WORLD_SIZE_X + 13.f);
			y = g_rng->RollRandomFloatInRange(0.f, WORLD_SIZE_Y);
			break;
		}
		return Vec2(x, y);
