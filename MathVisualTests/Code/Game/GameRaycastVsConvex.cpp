...
GameRaycastVsConvex::GameRaycastVsConvex() : Game()
{
...
GameRaycastVsConvex::~GameRaycastVsConvex()
{

}

void GameRaycastVsConvex::Startup()
{
...
void GameRaycastVsConvex::Update(float deltaSeconds)
{
...
void GameRaycastVsConvex::Render() const
{
...
void GameRaycastVsConvex::Shutdown()
{

}

void GameRaycastVsConvex::UpdateEntities(float deltaSeconds)
{
	UNUSED(deltaSeconds);
	m_didImpact = false;
...
void GameRaycastVsConvex::DeleteGarbageEntities()
{

}

void GameRaycastVsConvex::KillAll()
{

}

void GameRaycastVsConvex::UpdateFromKeyboard(float deltaSeconds)
{
	UNUSED(deltaSeconds);
...
void GameRaycastVsConvex::UpdateFromController(float deltaSeconds)
{
	UNUSED(deltaSeconds);
...
void GameRaycastVsConvex::RenderAttractMode() const
{
...
void GameRaycastVsConvex::RenderUI() const
{
	g_theRenderer->BeginCamera(m_screenCamera);
...
void GameRaycastVsConvex::RenderEntities() const
{
	g_theRenderer->BeginCamera(m_worldCamera);
...
void GameRaycastVsConvex::RenderPaused() const
{
	g_theRenderer->BeginCamera(m_screenCamera);
...
void GameRaycastVsConvex::DebugRenderEntities() const
{
	g_theRenderer->BeginCamera(m_worldCamera);
	g_theRenderer->EndCamera(m_worldCamera);
}

void GameRaycastVsConvex::EnterGame()
{
	Shutdown();
	Startup();
...
void GameRaycastVsConvex::SetCamera()
{
...
void GameRaycastVsConvex::RandomizeShapes()
{
	for (int entityIndex = 0; entityIndex < m_shapes.size(); entityIndex++)
	{
		ShapeEntity2D*& tempEntity = m_shapes[entityIndex];
...
void GameRaycastVsConvex::ReturnAttractModeVictory()
{
	ReturnAttractModeNormal();
}

void GameRaycastVsConvex::ReturnAttractModeFailed()
{
	ReturnAttractModeNormal();

}

void GameRaycastVsConvex::ReturnAttractModeNormal()
{
